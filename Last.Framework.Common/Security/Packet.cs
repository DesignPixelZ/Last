...
namespace Last.Framework.Common.Security
{
    public class Packet : IDisposable
    {
        ...
        public TPaddedString ReadPaddedString<TPaddedString>() where TPaddedString : struct, IPaddedString
        {
            return this.ReadStruct<TPaddedString>();
        }
        ...
        public void WritePaddedString<TPaddedString>(TPaddedString value) where TPaddedString : struct, IPaddedString
        {
            this.WriteStruct<TPaddedString>(value);
        }
